var qp={mode:"by_days",tail_k:"0"};process.argv.slice(2).map(e=>e.split("=")).map(e=>qp[e[0]]=e.length<2?"true":e[1]);
var fs=require('fs');
...
var fn='nvme_main.log';var k=parseFloat(qp.tail_k);
var str=""+(k?tail(fn,k):fs.readFileSync(fn));
